...
The Universal engine has a lot of heated parts running at max, one of them being the Rat Races, in all forms. Saw a recent IIT's freshers intro where a student was asked a question 'why choose engineering' which he replied confused that his goal was to crack IIT.

**The making out game:**
Capitalist wants more profit => need to exploit work force.
worker want to maintain a healthy life and earning => working not at their max, so less profit for company

We see a conflict in interest so what's the solution ?

capitalist establish a simple rule that if a person generate less than a limit, he will receive a base pay and every unit generated by an individual over that limit will give him/her bonus.
...
All worker start working extra hard and now as everyone is working hard capitalist keep pushing the limit.
...
You see, all students around me are preparing from same sheets(of DSA) trying to learn all "standard" questions 
...
They just want to land a high paying job but as one said, journey is important than destination. 
...
Being successful like my friends would have been great but being me don't sucks either.
